        ...
        <div class="container pt-lg-5 pt-md-4">
            <div class="row">
                <div class="col-lg-9 most-recent">
                    ...
                    <div class="list-view">
                        <?php include 'get_most_recent_technology.php'; ?> <!-- Ini akan menampilkan 5 artikel terbaru dari database -->
                    </div>
                ...
                <div class="col-lg-3 trending mt-lg-0 mt-5 mb-lg-5">
                    <div class="pos-sticky">
                        ...
                        <?php include 'get_trending_technology.php'; ?> <!-- Ini akan menampilkan 5 artikel trending dari database -->
                    </div>
                </div>
            </div>
        </div>
