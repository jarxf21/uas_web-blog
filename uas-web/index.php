        ...
        <nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
            <div class="container">
                <a class="navbar-brand" href="index.html">
                    <span class="fa fa-pencil-square-o"></span> Web Programming fajar Blog</a>
        ...
        <div class="container pt-lg-5 pt-md-4">
            <div class="row">
                <div class="col-lg-9 most-recent">
                    ...
                    <div class="list-view">
                        <?php include 'get_most_recent.php'; ?> <!-- Ini akan menampilkan 5 artikel terbaru dari database -->
                    </div>
                    <!-- Pagination, jika diperlukan -->
                    <div class="pagination-wrapper mt-5">
                        <!-- Isi pagination, sesuai kebutuhan -->
                    </div>
                </div>
                ...
                <div class="col-lg-3 trending mt-lg-0 mt-5 mb-lg-5">
                    <div class="pos-sticky">
                        ...
                        <?php include 'get_trending.php'; ?> <!-- Ini akan menampilkan 5 artikel trending dari database -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-content py-lg-5 py-4 text-center">
            <div class="container">
                <div class="copy-right">
                    <h6>© 2024 Web Programming Blog . Made by <i>FAJAR</i> with <span class="fa fa-heart" aria-hidden="true"></span><br>Designed by
