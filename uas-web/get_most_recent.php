...
$recentQuery = "SELECT posts.id, posts.title, posts.content, posts.author, posts.image_url, posts.created_at, posts.views, categories.name AS category 
                ...
                JOIN categories ON posts.category_id = categories.id 
                 WHERE categories.name IN ('technology', 'lifestyle')
...
$totalQuery = "SELECT COUNT(*) as total FROM posts JOIN categories ON posts.category_id = categories.id WHERE categories.name IN ('technology', 'lifestyle')";
